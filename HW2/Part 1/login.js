function openModal() {
	...
	myInput.onkeyup = function() {
       //console.log('helllooo')
         ...
         */
        console.log(letter.classList) // debugging
        ...
        console.log(capital.classList) // debugging
        ...
        console.log(number.classList) // debugging
        // Validate numbers
        ...
        console.log(length.classList) // debugging
        // Validate length
