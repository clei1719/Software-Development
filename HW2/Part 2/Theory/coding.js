function display2_1() {
  var myanswer  = "undefined because that attribute does not exist, the last two console.log statements output true and then false, the first is comparing the == as a string or int, vs === as a strict literal which would just want to see an int to int compare, but would throw false for an int to string compare." // TODO 2.1: Fill in Answer here after the :
  document.getElementById("21answer").innerHTML = myanswer; // Do not change
}
function display2_2() {
  var myanswer  = "This will cause an error because x is not declared. The 'use strict', when removed, will allow errors to occur without warning you." // TODO 2.2: Fill in Answer here
...
function getChildrenTags() { // Do not add or remove lines to this function
  var children = document.getElementById("div_1134").children;
   // TODO: Question 2.5 Use the appropriate function to get all the children of a div named 'div_1134'
